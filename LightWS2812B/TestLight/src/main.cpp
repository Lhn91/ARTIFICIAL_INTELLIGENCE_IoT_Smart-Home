...
#include "Audio.h"
// Các chân I2S
#define I2S_BCLK  26  // Chân Bit Clock (BCLK)
#define I2S_LRC   25  // Chân Left-Right Clock (LRCK)
#define I2S_DOUT  22  // Chân Data Out (DOUT)
...
void setupI2S() {
  ...
  audio.setVolume(90);  // Cài đặt âm lượng cho đầu ra
}
